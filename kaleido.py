...
def print_help():
    ...
    print('  -i INTERVAL         Specify the minimum sync interval in sync-forever [default: %s]' % options.sync_interval)
    ...
    print('  -t INTERVAL         Set the minimum interval for beacon reconnection [default: %s]' % options.reconnect_interval)
